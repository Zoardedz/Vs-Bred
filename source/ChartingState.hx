...
class ChartingState extends MusicBeatState
{
	...
	var noteSpecial:Int = 0;
	var Styles:Array<String> = ["normal","bred","Bred note of harming","Bred Note of confoooosion"];

	var noteTypeInd:FlxText = new FlxText(-5,0,0,"Charting note: ",16);
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		noteTypeInd.text = "Charting Note: " + Styles[noteSpecial];
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = new Note(daStrumTime, daNoteInfo % 4, daSpecial);
	...
	private function addNote(?n:Note):Void
	{
		...
		var noteSus = 0;
		var noteSpecial = Styles[this.noteSpecial];

		if (n != null)
			_song.notes[curSection].sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, n.noteSpecial]);
		else
			_song.notes[curSection].sectionNotes.push([noteStrum, noteData, noteSus, noteSpecial]);
